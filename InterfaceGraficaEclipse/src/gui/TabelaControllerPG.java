...
public class TabelaControllerPG extends Application implements Initializable{
...
private static Stage stage;
	...
	public static void setStage(Stage stage) {
		TabelaControllerPG.stage = stage;
	}
	
	public void fecharTela() {
		TabelaControllerPG.getStage().close();
	}
