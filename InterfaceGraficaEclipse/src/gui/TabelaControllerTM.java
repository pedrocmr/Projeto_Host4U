...
public class TabelaControllerTM extends Application implements Initializable{
...
private static Stage stage;
	...
	public static void setStage(Stage stage) {
		TabelaControllerTM.stage = stage;
	}
	
	public void fecharTela() {
		TabelaControllerTM.getStage().close();
	}
